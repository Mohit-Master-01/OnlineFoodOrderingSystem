<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="FOS.User.Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="book_section" style="background-image: url('../assets/payment.png'); width: 100%; height: 100%; background-repeat: no-repeat; background-size: auto; background-attachment: fixed; background-position: left;">
                        ...
                        <div class="card-header">
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                    ...
                                    <li class="nav-item"><a data-toggle="pill" href="#paypal" class="nav-link "><i class="fas fa-mobile-alt mr-2"></i>Cash on Delivery</a></li>
                                </ul>
                            </div>
                            <!-- End -->
                                    ...
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                                ...
                                                ValidationExpression="^[a-zA-Z\s]+$" ControlToValidate="txtName" ValidationGroup="card">*</asp:RegularExpressionValidator>
...
<%--                                                    <asp:RequiredFieldValidator ID="rfvExpMonth" runat="server" ErrorMessage="Expiry month is required"
                                                        ControlToValidate="txtPaymentDate" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"
                                                        ValidationGroup="card">*</asp:RequiredFieldValidator>
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtPaymentDate" runat="server" CssClass="form-control" placeholder="Date"
                                                            TextMode="Number"></asp:TextBox>
                                                    </div>--%>
                                              <%--  </div>
                                            </div>
...
<%--                                        <div class="form-group">
                                        ...
                                        <div class="card-footer">
                                            <asp:LinkButton ID="lbCardSubmit" runat="server" CssClass="subscribe btn btn-info btn-block shadow-sm"
                                                ValidationGroup="card" CommandName="Card" OnCommand="lbCardSubmit_Command" OnClick="lbCardSubmit_Click">Confirm Payment</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                <!-- End -->
    ...
    <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder=" Name"></asp:TextBox>
                        ...
                        <div class="card-footer">
                            <b class="badge badge-pill shadow-sm text-center bg-dark">Order Total:₹ <%
                                                                                                        Response.Write(Session["grandTotalPrice"]); %> </b>
                            <div class="pt-1">
